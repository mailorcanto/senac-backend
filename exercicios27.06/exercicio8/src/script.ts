...
function renewId ():any{
	...
	let dataNasc: string | null |undefined = prompt('Informe sua data de nascimento');
	...
	let dataRenov:string = `10/10/2010`;
	let renov: any[] = dataRenov.split('/');
	...
	if (idadeDias / 365 <= 20){ if(renovDias / 365 >= 5){
